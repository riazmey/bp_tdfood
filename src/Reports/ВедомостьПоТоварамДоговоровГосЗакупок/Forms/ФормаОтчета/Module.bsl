...
Функция ПодготовитьПараметрыОтчета()
	...
	ПараметрыОтчета.Вставить("ОтборГдеКонОстатокМеньшеНуля"     , Отчет.ОтборГдеКонОстатокМеньшеНуля);
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Ведомость по товарам договоров (гос. закупки)" + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода);
...
Функция ПолучитьПараметрыВыбораЗначенияОтбора() Экспорт
	...
	СписокПараметров.Вставить("НоменклатураГосЗакупок", Неопределено);
	СписокПараметров.Вставить("Контрагент"            , Неопределено);
	СписокПараметров.Вставить("ДоговорКонтрагента"    , Неопределено);
	СписокПараметров.Вставить("ПоказательКоличество"  , Отчет.ПоказательКоличество);
	СписокПараметров.Вставить("ПоказательСумма"       , Отчет.ПоказательСумма);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтаФорма,
		"БП.Отчет.ВедомостьПоТоварамДоговоровГосЗакупок",
		"ФормаОтчета",
		НСтр("ru='Новости: Ведомость по товарам договоров (гос. закупки)'"),
...
Процедура ПриОткрытии(Отказ)
	...
	КлючеваяОперация = "ФормированиеОтчетаВедомостьПоТоварамДоговоровГосЗакупок";
	ВремяНачалаОперации = Неопределено;
