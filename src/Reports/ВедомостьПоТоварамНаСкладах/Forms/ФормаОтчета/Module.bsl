...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Ведомость по товарам на складах" + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтаФорма,
		"БП.Отчет.ВедомостьПоТоварамНаСкладах",
		"ФормаОтчета",
		НСтр("ru='Новости: Ведомость по товарам на складах'"),
...
Процедура ПриОткрытии(Отказ)
	...
	КлючеваяОперация = "ФормированиеОтчетаВедомостьПоТоварамНаСкладах";
	ВремяНачалаОперации = Неопределено;
